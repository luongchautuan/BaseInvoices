...
-(id)initWithFrame:(CGRect)frame {
    ...
    if ([super initWithFrame:frame]) {
        ...
        // Default Colors.
        self.backgroundColor = [UIColor colorWithRed:214.0/255.0 green:231.0/255.0 blue:195.0/255.0 alpha:1.0];
        self.backgroundColorTitle = [UIColor colorWithRed:34.0/255.0 green:34.0/255.0 blue:34.0/255.0 alpha:1.0];
        self.backgroundColorButtonValid = [UIColor colorWithRed:103.0/255.0 green:175.0/255.0 blue:18.0/255.0 alpha:1.0];
        self.backgroundColorButtonCancel = [UIColor colorWithRed:103.0/255.0 green:175.0/255.0 blue:18.0/255.0 alpha:1.0];
